...
const Sidebar = ({ isOpen, setOpen, gamification = { xp: 240, level: 3, dailyStreak: 5, nextLevelXp: 900 } }) => {
  const navItems = [
  ...
  return (
    <>
      ...
      <aside className={`w-64 h-screen bg-background border-r border-border fixed left-0 top-0 z-[70] flex flex-col p-6 isolate transition-transform duration-500 ease-in-out ${
        isOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"
      }`}>
        {/* Brand */}
        <div className="flex items-center gap-3 mb-10 group cursor-pointer" onClick={() => setOpen(false)}>
